export default {
  ...
  setup: {
    title: 'Nexora Setup',
    description: 'Configure your Nexora instance',
    database: {
  ...
  // Auth
  auth: {
    brandSubtitle: 'AI gateway and routing platform',
    brandingHint:
      'Branding, announcements, legal pages, and payment settings are all managed from the admin panel.',
  ...
  availableChannels: {
    ...
    marketplace: {
      ...
      description: 'See the models available to you by group, with effective input, output and cache pricing already applied.',
      searchPlaceholder: 'Search models, groups or channels...',
      marketView: 'Marketplace',
      tableView: 'Table',
      resultsUnit: 'entries',
      resetFilters: 'Reset filters',
      filtersTitle: 'Filters',
      filtersHint: 'Filter by platform, accessible group and billing mode.',
      clearAll: 'Clear all',
      platforms: 'Platforms',
      groups: 'Groups',
      billingModes: 'Billing Modes',
      empty: 'No models match the current filters',
      showingResults: 'Showing {count} pricing entries',
      groupFilterActive: '{count} groups selected',
      billingFilterActive: '{count} billing modes selected',
      effectiveRate: 'Effective rate',
      defaultRate: 'Default rate',
      unknownBillingMode: 'Unknown',
      stats: {
        models: 'Models',
        groups: 'Groups',
        channels: 'Channels'
  ...
  admin: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for Nexora end-user login',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        ...
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Nexora is an enterprise AI gateway platform for managing access, routing, and billing across upstream AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers and access policies</li><li>🔗 <b>Channel Routing</b> - Connect multiple upstream AI providers</li><li>🔑 <b>Key Distribution</b> - Issue independent API Keys to users</li><li>💰 <b>Billing Control</b> - Apply rate, quota, and recharge rules</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core service partition in Nexora, similar to a packaged access tier:</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Nexora',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Nexora AI gateway platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create an API Key</li><li>📋 Copy the key into your application</li><li>🚀 Start calling AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
