export default {
  ...
  // Auth
  auth: {
    brandSubtitle: '智能模型网关与路由平台',
    brandingHint: '品牌、公告、条款页面与支付配置都可以在后台统一管理。',
    welcomeBack: '欢迎回来',
  ...
  availableChannels: {
    ...
    marketplace: {
      title: '模型广场',
      description: '按你当前可访问的分组直接展开模型价格，输入、输出和缓存价格都会按实际倍率展示。',
      ...
      resetFilters: '重置筛选',
      filtersTitle: '筛选',
      filtersHint: '按平台、可访问分组和计费模式过滤。',
      clearAll: '清空',
      platforms: '平台',
      groups: '分组',
      billingModes: '计费模式',
      empty: '当前筛选下没有可展示的模型',
      showingResults: '共展示 {count} 条定价',
      groupFilterActive: '已选 {count} 个分组',
      billingFilterActive: '已选 {count} 种计费模式',
      effectiveRate: '当前倍率',
      defaultRate: '默认倍率',
      unknownBillingMode: '未知',
      stats: {
        models: '模型数',
        groups: '分组数',
        channels: '渠道数'
  ...
  admin: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 Nexora 用户登录',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 Nexora',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Nexora 是企业级 AI 中转与网关平台，帮助您统一管理上游模型接入、路由和计费。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐和权限策略</li><li>🔗 <b>渠道路由</b> - 接入多个上游 AI 服务商</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活控制费率、额度和充值规则</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 Nexora 的核心概念，可以理解为一个服务套餐或访问层级：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建“VIP 专线”和“免费试用”两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的“分组管理”开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 Nexora',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好，欢迎来到 Nexora AI 网关平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始调用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
