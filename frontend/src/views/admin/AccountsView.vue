                ...
                >
                  <div class="max-h-[70vh] overflow-y-auto p-2">
                    ...
                    <button class="account-tools-menu-item" @click="openSyncFromCrs">
                      <span class="account-tools-menu-icon bg-accent-50 text-accent-600 dark:bg-accent-900/30 dark:text-accent-300">
            ...
            <div class="flex flex-col items-start gap-1">
              ...
              <div v-if="isExpired(value) || (row.auto_pause_on_expired && value)" class="flex items-center gap-1">
                ...
                <span
                  ...
                  class="inline-flex items-center rounded-md bg-primary-100 px-2 py-0.5 text-xs font-medium text-primary-700 dark:bg-primary-900/30 dark:text-primary-300"
                >
  ...
  switch (state) {
    case 'active':
      return {
        ...
        dotClass: 'bg-primary-500 shadow-[0_0_0_2px_rgba(var(--color-primary-rgb),0.14)]'
      }
    case 'blocked':
      return {
...
function getAntigravityTierClass(row: any): string {
  ...
  switch (tier) {
    ...
    case 'g1-pro-tier': return 'bg-accent-100 text-accent-600 dark:bg-accent-900/40 dark:text-accent-300'
...
const syncPaginationAfterLocalRemoval = () => {
  ...
  // 琛岃鏈湴绉婚櫎鍚庝笉绔嬪埢鍏ㄩ噺琛ラ〉锛屾敼涓烘彁绀虹敤鎴锋墜鍔ㄥ悓姝ャ€?  hasPendingListSync.value = nextTotal > 0
}
