          ...
          <template #cell-usage="{ row }">
            <div class="min-w-[280px] space-y-2">
              ...
              <div
                ...
                "
                class="flex items-center gap-2 rounded-lg bg-gradient-to-r from-primary-50 to-accent-50 px-3 py-2 dark:from-primary-900/20 dark:to-accent-900/20"
              >
