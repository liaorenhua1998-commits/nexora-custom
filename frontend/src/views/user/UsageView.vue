        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="flex items-center gap-3">
            <div class="rounded-lg bg-accent-100 p-2 dark:bg-accent-900/30">
              <Icon name="document" size="md" class="text-accent-600 dark:text-accent-400" />
            </div>
            <div>
        ...
        >
          ...
          <template #cell-tokens="{ row }">
            ...
            <div v-else class="flex items-center gap-1.5">
              ...
              >
                <div
                  class="flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-gray-100 transition-colors group-hover:bg-accent-100 dark:bg-gray-700 dark:group-hover:bg-accent-900/50"
                >
                  <Icon
                    name="infoCircle"
                    size="xs"
                    class="text-gray-400 group-hover:text-accent-500 dark:text-gray-500 dark:group-hover:text-accent-400"
                  />
                </div>
              </div>
            </div>
...
const getRequestTypeBadgeClass = (log: UsageLog): string => {
  ...
  if (requestType === 'stream') return 'bg-accent-100 text-accent-800 dark:bg-accent-900 dark:text-accent-200'
