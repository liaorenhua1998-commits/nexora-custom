    ...
    <div class="mx-auto max-w-lg space-y-6 py-8">
      ...
      <template v-else>
        ...
        <div v-if="order" class="card overflow-hidden">
          <div class="bg-gradient-to-br from-primary-500 to-accent-500 px-6 py-6 text-center">
            <p class="text-sm font-medium text-primary-100">{{ t('payment.actualPay') }}</p>
        ...
        <template v-if="wechatQrUrl">
          <div class="card p-6">
            <div class="flex flex-col items-center space-y-4">
              ...
              <div class="relative rounded-lg border-2 border-primary-400 bg-primary-50 p-4 dark:border-primary-500/70 dark:bg-primary-950/20">
                <img :src="wechatQrUrl" alt="WeChat Pay QR" class="h-56 w-56 rounded" />
                <div class="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <span class="rounded-full bg-primary-500 p-2 shadow ring-2 ring-white">
        ...
        <template v-else-if="redirecting">
          <div class="card p-6">
            <div class="flex flex-col items-center space-y-4 py-4">
              <div class="h-10 w-10 animate-spin rounded-full border-4 border-accent-500 border-t-transparent"></div>
          ...
          <div class="card p-6 text-center">
            <div class="flex flex-col items-center gap-3 py-4">
              <div class="flex h-16 w-16 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900/30">
                <Icon name="check" size="lg" class="text-primary-500" />
              </div>
...
const rootComponent = computed(() => (isPopup.value ? StandalonePageShell : AppLayout))
const rootProps = computed(() => (isPopup.value ? { maxWidth: 'lg' as const } : {}))
...
async function confirmAlipay(stripe: Stripe, clientSecret: string, orderId: number) {
  ...
  // If no error, Stripe redirects automatically 鈥?nothing else to do
}
