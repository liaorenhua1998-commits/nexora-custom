<template>
    ...
    <div v-if="!isSimple" class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-primary-600 dark:text-primary-400">${{ formatBalance(balance) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-accent-100 p-2 dark:bg-accent-900/30">
          <Icon name="key" size="md" class="text-accent-600 dark:text-accent-400" :stroke-width="2" />
        </div>
        <div>
          ...
          <p class="text-xs text-primary-600 dark:text-primary-400">{{ stats?.active_api_keys || 0 }} {{ t('common.active') }}</p>
        </div>
      </div>
    </div>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-accent-100 p-2 dark:bg-accent-900/30">
          <Icon name="database" size="md" class="text-accent-600 dark:text-accent-400" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="text-sm font-semibold text-primary-600 dark:text-primary-400">{{ formatTokens(stats?.tpm || 0) }}</p>
