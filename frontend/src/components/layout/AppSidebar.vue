<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <div class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-xl border border-white/45 bg-white/68 shadow-[0_12px_30px_rgba(15,23,42,0.10)] backdrop-blur-xl dark:border-white/10 dark:bg-white/8">
        ...
        <div class="sidebar-section">
          <template v-for="item in adminNavItems" :key="item.path">
            ...
            <template v-if="item.children?.length">
              ...
              <!-- Children -->
              <div v-if="!sidebarCollapsed && isGroupExpanded(item)" class="mb-1 ml-4 border-l border-white/35 pl-2 dark:border-white/10">
                <router-link
    ...
    <!-- Bottom Section -->
    <div class="mt-auto border-t border-white/35 p-3 dark:border-white/8">
      <!-- Theme Toggle -->
      <button
        @click="toggleTheme"
