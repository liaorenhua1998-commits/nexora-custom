<template>
    ...
    <template v-if="loading">
      <div v-for="i in 5" :key="i" class="glass-card p-4">
        <div class="space-y-3">
          ...
          <div v-if="hasActionsColumn" class="border-t border-white/35 pt-3 dark:border-white/10">
  ...
  >
    <table class="w-full min-w-max divide-y divide-white/30 dark:divide-white/8">
      <thead class="table-header bg-white/28 backdrop-blur-xl dark:bg-white/5">
        <tr>
          <th
            ...
            :class="[
              ...
              { 'cursor-pointer hover:bg-white/45 dark:hover:bg-white/8': column.sortable },
      ...
      <tbody class="table-body divide-y divide-white/25 bg-white/18 dark:divide-white/6 dark:bg-white/0">
        <!-- Loading skeleton -->
        ...
        <template v-else>
          ...
          <tr
            ...
            :ref="measureElement"
            class="hover:bg-white/30 dark:hover:bg-white/5"
          >
            <td
