    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        <div
          ...
          @click="closeModal"
        >
          <div class="glass-card w-full max-w-[620px] overflow-hidden rounded-3xl" @click.stop>
            <div class="relative overflow-hidden border-b border-white/50 bg-gradient-to-br from-primary-50/70 via-white/60 to-accent-50/50 px-6 py-5 dark:border-white/10 dark:from-primary-500/12 dark:via-dark-900/50 dark:to-accent-500/10">
              <div class="relative z-10 flex items-start justify-between">
                <div>
                  <div class="flex items-center gap-2">
                    <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-primary-500 via-primary-600 to-accent-500 text-white shadow-lg shadow-primary-500/30">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    @click="markAllAsRead"
                    :disabled="loading"
                    class="btn-primary rounded-lg px-4 py-2 text-xs disabled:opacity-50"
                  >
              ...
              <div class="absolute right-0 top-0 h-full w-48 bg-gradient-to-l from-primary-200/20 to-transparent dark:from-primary-500/10"></div>
            </div>
            ...
            <div class="max-h-[65vh] overflow-y-auto">
              ...
              <div v-else-if="announcements.length > 0">
                <div
                  ...
                  :class="{ 'bg-primary-50/35 dark:bg-primary-500/8': !item.read_at }"
                ...
                >
                  <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center">
                    <div
                      v-if="!item.read_at"
                      class="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary-500 via-primary-600 to-accent-500 text-white shadow-lg shadow-primary-500/30"
                    >
                  ...
                  <div
                    v-if="!item.read_at"
                    class="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-primary-500 to-accent-500"
                  ></div>
                </div>
              </div>
              ...
              <div v-else class="flex flex-col items-center justify-center py-16">
                <div class="relative mb-4">
                  ...
                  <div class="absolute -right-1 -top-1 flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-accent-500 text-white">
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        <div
          ...
          @click="closeDetail"
        >
          <div class="glass-card w-full max-w-[780px] overflow-hidden rounded-3xl" @click.stop>
            <div class="relative overflow-hidden border-b border-white/50 bg-gradient-to-br from-primary-50/80 via-white/65 to-accent-50/45 px-8 py-6 dark:border-white/10 dark:from-primary-500/15 dark:via-dark-900/45 dark:to-accent-500/10">
              <div class="absolute right-0 top-0 h-full w-64 bg-gradient-to-l from-primary-200/30 to-transparent dark:from-primary-500/16"></div>
              <div class="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-gradient-to-br from-primary-400/22 to-accent-500/18 blur-3xl"></div>
              <div class="absolute -left-4 -bottom-4 h-24 w-24 rounded-full bg-gradient-to-tr from-accent-400/18 to-primary-500/16 blur-2xl"></div>

              <div class="relative z-10 flex items-start justify-between gap-4">
                <div class="min-w-0 flex-1">
                  <div class="mb-3 flex items-center gap-2">
                    <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary-500 via-primary-600 to-accent-500 text-white shadow-lg shadow-primary-500/30">
                      <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <div class="flex items-center gap-2">
                      ...
                      <span
                        ...
                        class="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-primary-500 via-primary-600 to-accent-500 px-2.5 py-1 text-xs font-medium text-white shadow-lg shadow-primary-500/30"
                      >
            ...
            <div class="max-h-[60vh] overflow-y-auto bg-white/35 px-8 py-8 dark:bg-dark-900/25">
              <div class="relative">
                <div class="absolute bottom-0 left-0 top-0 w-1 rounded-full bg-gradient-to-b from-primary-500 via-primary-600 to-accent-500"></div>
                <div class="pl-6">
                  <div
            ...
            <div class="border-t border-white/45 bg-white/35 px-8 py-5 dark:border-white/10 dark:bg-dark-900/20">
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <button
                    ...
                    class="rounded-xl bg-gradient-to-r from-primary-500 via-primary-600 to-accent-500 px-5 py-2.5 text-sm font-medium text-white shadow-lg shadow-primary-500/30 transition-all hover:scale-105 hover:shadow-xl"
                  >
...
watch([isModalOpen, detailModalOpen, () => announcementStore.currentPopup], ([modal, detail, popup]) => {
...
.markdown-body blockquote {
  @apply relative my-5 border-l-4 border-primary-500 bg-primary-50/50 py-3 pl-5 pr-4 italic text-gray-700 dark:border-primary-400 dark:bg-primary-900/10 dark:text-gray-300;
}
...
.markdown-body code {
  @apply rounded-lg bg-gray-100 px-2 py-1 text-[13px] font-mono text-primary-700 dark:bg-dark-700 dark:text-primary-300;
}
...
.markdown-body th {
  @apply bg-gradient-to-br from-primary-50 to-accent-50 font-semibold text-gray-900 dark:from-primary-900/20 dark:to-accent-900/10 dark:text-white;
}
