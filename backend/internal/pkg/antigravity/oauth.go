...
const (
	...
	// AntigravityOAuthClientIDEnv and AntigravityOAuthClientSecretEnv configure the OAuth
	// credentials used for Antigravity. Real credentials are intentionally not embedded.
