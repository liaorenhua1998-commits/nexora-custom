...
const (
	...
	// GeminiCLIOAuthClientIDEnv and GeminiCLIOAuthClientSecretEnv configure the Gemini CLI OAuth
	// client used for Code Assist / Google One flows. Real credentials are intentionally not
