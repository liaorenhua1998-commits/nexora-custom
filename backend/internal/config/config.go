...
type UpdateConfig struct {
	// GitHubRepo is the release repository used by online updates.
	// Format: owner/repo. Use your branded fork here to keep custom UI.
...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/nexora")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "nexora")
	...
	viper.SetDefault("database.dbname", "nexora")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "nexora:")
